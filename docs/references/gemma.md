...
| Google DeepMind reference implementation | local: [`upstream/gemma/`](upstream/gemma) (submodule, opt-in init); upstream: <https://github.com/google-deepmind/gemma> | architecture (JAX/Flax), parameter counts, attention shape |
