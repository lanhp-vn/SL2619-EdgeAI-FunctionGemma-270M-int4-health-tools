...
flowchart TB
    ...
    subgraph DD[Dispenser voice pipeline - v1 shipping shape]
        ...
        BLE[BLE GATT - PROVEN e2e to real dispenser 2026-06-10 via pybleno; dispatch notify wiring pending]
